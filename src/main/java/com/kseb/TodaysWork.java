...
public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {	
		...
		System.out.println(ConsId+"+++"+Lineman);

		try {
			
			pst = conn.prepareStatement("INSERT INTO lineman_duty(comp_id,fk_login_id) VALUES("+ConsId+","+Lineman+")");
			int flag= pst.executeUpdate("INSERT INTO lineman_duty(comp_id,fk_login_id) VALUES("+ConsId+","+Lineman+")");
